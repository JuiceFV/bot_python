...
def Algeometry():
   message = '''Материалы по алгему
   1) https://abc.vvsu.ru/books/l_matemk1/default.asp (Алгем за 1-ый семестр)
   2) https://abc.vvsu.ru/books/l_matemk1/page0004.asp#xex7 (Матрицы)
   3) https://abc.vvsu.ru/books/l_matemk1/page0012.asp#xex20 (Векторы)
   4) http://edu.alnam.ru/index.php#1 (Вся математика)'''
   return message, ''

Algeometry_com = command_system.Command()

Algeometry_com.keys = ['/алгем','/алгебра']
Algeometry_com.description = 'Аналитическая геометрия'
Algeometry_com.process = Algeometry

def Matrix():
    message = '''Матрицы
    1) https://abc.vvsu.ru/books/l_matemk1/page0004.asp#xex7'''
    return message, ''

Matrix_com = command_system.Command()

Matrix_com.keys = ['/матрицы']
Matrix_com.description = 'Матрицы (Алгем)'
Matrix_com.process = Matrix

def Vector_Alg():
    message ='''Векторная алгебра и геометрия
    1) https://abc.vvsu.ru/books/l_matemk1/page0012.asp#xex20'''
    return message, ''

Vector_com = command_system.Command()

Vector_com.keys = [r'/векторы']
Vector_com.description = 'Векторная алгебра и геометрия (Алгем)'
Vector_com.process = Vector_Alg

def Questions_Vec():
    message='''Векторная алгебра и аналитическая геометрия.
...
'''
    return message,''
QuestionV_com = command_system.Command()

QuestionV_com.keys = [r'/вопросы алгем вектор']
QuestionV_com.description = 'Вопросы к экзамену/зачёту по Алгему тема - вектор и пространство'
QuestionV_com.process = Questions_Vec
...
11. Ранг матрицы. Вычисление ранга матрицы методом окаймляющих миноров.12. Ранг матрицы.  Вычисление ранга матрицы методом элементарных преобразований.
...
17. Метод последовательных исключений Жордана-Гаусса.'''
    return message,''
QuestionM_com = command_system.Command()

QuestionM_com.keys = [r'/вопросы алгем матрицы']
QuestionM_com.description = 'Вопросы к экзамену/зачёту по Алгему тема - Матрицы'
QuestionM_com.process = Questions_Matr